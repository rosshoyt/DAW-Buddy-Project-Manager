const AdvancedArray = require('../../common/utils/advanced-array');
const DAWProjectEntry = require('../../common/model/daw-project-entry');
const StringUtils = require('../../common/utils/string-utils');
const FileInfo = require('../../common/model/file-info');
const fs = require('fs');

...
class WindowController {
    ...
    // TODO implement shared window creation function to avoid duplicated code, e.g. createWindow(height, width){ return new BrowserWindow}

    // TODO fix bug - only shows main window when a non-email username is submitted
    showMainWindow() {
